...
public class MyClass {
    ...
    public String toString() {
        return "MyClass [varStr=" + varStr + ", varInt=" + varInt + ", varLong=" + varLong + ", varByte=" + varByte
                + ", varShort=" + varShort + ", varFloat=" + varFloat + ", varDouble=" + varDouble + ", varBoolean="
                + varBoolean + ", varChar=" + varChar + ", varDate=" + varDate + "]";
    }
