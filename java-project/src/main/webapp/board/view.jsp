...
try {
    ...
    if (board != null) {
        %>
         ...
         <div class='col-sm-10'>  
         <input class='form-control' readonly id='regdate' type='date' value='<%=board.getRegDate()%>'>  
         ...
         <div class='col-sm-10'>  
         <input class='form-control' readonly id='viewcnt' type='number' value='<%=board.getViewCount()%>'>  
