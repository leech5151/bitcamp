...
인스턴스를 만드는 용도가 아니기 때문에 이넡페이스나 추상클래스도 가능하다.<br>
물론 이 이른도 반드시 Fully-Qualified Name 이어야 한다.<br>
...
이 속성을 생략하면 기본적으로 PasgeContext 보관소에 저장된다.<br>
